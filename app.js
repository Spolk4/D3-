...
d3.csv("data/data.csv", function (error, data) {
    ...
    let healthcareBelowLabel = labelsGroup.append("text")
      .attr("x", 0)
      .attr("y", 20)
      .attr("value", "healthcare_below") //value to grab for event listener
      .classed("active", true)
      .text("Healthcare (% Below Poverty Line)");
  
    let healthcareAboveLabel = labelsGroup.append("text")
      .attr("x", 0)
      .attr("y", 40)
      .attr("value", "healthcare_above") //value to grab for event listener
      .classed("inactive", true)
      .text("Healthcare (% Above Poverty Line)");
